...
$query = $con->query("SELECT id FROM tbladmin WHERE AdminEmailId = '$email'");
if (!$query->num_rows > 0) {
  # code...
   $result = "<div class='alert alert-danger alert-dismissible'>
 ...
 $code = uniqid(true);
 $query2 = mysqli_query($con, "INSERT INTO password_resets (email,code, date) VALUES ( '$email','$code', NOW())");
 if (!$query2) {
   # code...
