...
$status=1;
$query=mysqli_query($con,"insert into tblsubcategory(SportId,Subcategory,SubCatDescription,Is_Active) values('$categoryid','$subcatname','$subcatdescription','$status')");
if($query)
{
...
<html lang="en">
    <head>
        ...
        <title>FunOlympics | Add Sub Category</title>
