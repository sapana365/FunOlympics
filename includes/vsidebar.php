...
<div class="card my-4">
  ...
  <div class="card-body">
            <ul class="mb-0">
<?php
$query=mysqli_query($con,"select tblvideo.id as pid,tblvideo.videotitle as posttitle from tblvideo left join tblsport on tblsport.id=tblvideo.SportId left join  tblsubcategory on  tblsubcategory.SubCategoryId=tblvideo.SubCategoryId limit 8");
while ($row=mysqli_fetch_array($query)) {
