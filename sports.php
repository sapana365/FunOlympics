...
$query=mysqli_query($con,"select tblvideos.id as Sid,tblvideos.videotitle as posttitle,tblvideos.postvideo,tblsport.SportName as category,tblSport.Id as cid,tblsubcategory.Subcategory as subcategory,tblvideos.videodescription as postdetails,tblvideos.PostingDate as postingdate,tblvideos.VideoUrl as url from tblvideos left join tblsport on tblsport.Id=tblvideos.SportId left join  tblsubcategory on  tblsubcategory.SubCategoryId=tblvideos.SubCategoryId where tblvideos.Is_Active=1 order by tblvideos.id desc  LIMIT $offset, $no_of_records_per_page");
